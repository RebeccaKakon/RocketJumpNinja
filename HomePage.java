...
public class HomePage extends BasePage {
    ...
    private WebElement homeElement = driver.findElement(By.xpath("//*[@aria-label=\"Home\"]"));
    private static WebElement measureUnitX;

    static WebElement measurementDropdown = driver.findElement(By.id("measurement"));
    ...
    public static HashMap searchMice(HashMap miceData) {
        try {
            ...
            e.printStackTrace();
            // Handle the case where a suitable mouse is not found
            return new HashMap();
        }
    }
    ...
    // You can add more methods for handling other elements and interactions on the home page
}
